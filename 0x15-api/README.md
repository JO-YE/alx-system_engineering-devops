...
- [What is API](https://www.webopedia.com/definitions/api/)
- [What is an API? In English](https://www.freecodecamp.org/news/what-is-an-api-in-english-please-b880a3214a82/)
- [What is a REST](https://www.sitepoint.com/rest-api/)
- [What are nicroservices](https://smartbear.com/learn/api-design/microservices/)
